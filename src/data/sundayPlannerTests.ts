...
export const SUNDAY_11TH_TRACK1_TESTS: SundayPlannerTest[] = [
  {
    ...
    description: "Units and Measurements (Phy) + Some Basic Concepts of Chemistry (Chem) + The Living World (Bot) + Animal Kingdom (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-01 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Units and Measurements",
    chemistryUnit: "Some Basic Concepts of Chemistry",
    botanyBlock: "The Living World",
    zoologyBlock: "Animal Kingdom",
    physicsKeywords: ["Units and Measurement", "Physical World", "Vectors"],
    chemistryKeywords: ["Some Basic Concepts of Chemistry", "Mole Concept", "Stoichiometry"],
    botanyKeywords: ["The Living World", "Taxonomy", "Binomial Nomenclature"],
    zoologyKeywords: ["Animal Kingdom", "Invertebrates", "Chordates", "Non-chordates"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Motion in a Straight Line; Motion in a Plane (Phy) + Structure of Atom (Chem) + Biological Classification (Bot) + Structural Organisation in Animals (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-02 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Motion in a Straight Line; Motion in a Plane",
    chemistryUnit: "Structure of Atom",
    botanyBlock: "Biological Classification",
    zoologyBlock: "Structural Organisation in Animals",
    physicsKeywords: ["Motion in a Straight Line", "Motion in a Plane", "Kinematics"],
    chemistryKeywords: ["Structure of Atom", "Quantum Numbers", "Photoelectric Effect"],
    botanyKeywords: ["Biological Classification", "Monera", "Protista", "Fungi", "Viruses"],
    zoologyKeywords: ["Structural Organisation in Animals", "Animal Tissues", "Epithelial Tissue", "Connective Tissue", "Frog"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Laws of Motion (Phy) + Classification of Elements and Periodicity in Properties (Chem) + Plant Kingdom (Bot) + Breathing and Exchange of Gases (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-03 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Laws of Motion",
    chemistryUnit: "Classification of Elements and Periodicity in Properties",
    botanyBlock: "Plant Kingdom",
    zoologyBlock: "Breathing and Exchange of Gases",
    physicsKeywords: ["Laws of Motion", "Friction", "Circular Motion"],
    chemistryKeywords: ["Classification of Elements and Periodicity in Properties", "Periodic Table", "Periodic Properties"],
    botanyKeywords: ["Plant Kingdom", "Algae", "Bryophytes", "Pteridophytes", "Gymnosperms", "Angiosperms"],
    zoologyKeywords: ["Breathing and Exchange of Gases", "Respiratory Volumes", "Gas Transport"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Work, Energy and Power (Phy) + Chemical Bonding and Molecular Structure (Chem) + Morphology of Flowering Plants (Bot) + Body Fluids and Circulation (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-04 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Work, Energy and Power",
    chemistryUnit: "Chemical Bonding and Molecular Structure",
    botanyBlock: "Morphology of Flowering Plants",
    zoologyBlock: "Body Fluids and Circulation",
    physicsKeywords: ["Work, Energy and Power", "Power", "Energy"],
    chemistryKeywords: ["Chemical Bonding and Molecular Structure", "Hybridization", "VSEPR Theory", "Molecular Orbital Theory"],
    botanyKeywords: ["Morphology of Flowering Plants", "Root, Stem, Leaf", "Inflorescence", "Flower, Fruit, Seed"],
    zoologyKeywords: ["Body Fluids and Circulation", "Blood and Lymph", "Human Heart", "Cardiac Cycle", "ECG"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "System of Particles and Rotational Motion (Phy) + Thermodynamics (Chem) + Anatomy of Flowering Plants (Bot) + Excretory Products and Their Elimination (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-05 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "System of Particles and Rotational Motion",
    chemistryUnit: "Thermodynamics",
    botanyBlock: "Anatomy of Flowering Plants",
    zoologyBlock: "Excretory Products and Their Elimination",
    physicsKeywords: ["System of Particles and Rotational Motion", "Rotational Motion", "Moment of Inertia"],
    chemistryKeywords: ["Thermodynamics", "Chemical Thermodynamics", "Enthalpy", "Entropy"],
    botanyKeywords: ["Anatomy of Flowering Plants", "Meristematic Tissues", "Permanent Tissues", "Secondary Growth"],
    zoologyKeywords: ["Excretory Products and Their Elimination", "Human Excretory System", "Urine Formation", "Regulation of Kidney Function"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Gravitation (Phy) + Equilibrium (Chem) + Cell: The Unit of Life (Bot) + Locomotion and Movement (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-06 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Gravitation",
    chemistryUnit: "Equilibrium",
    botanyBlock: "Cell: The Unit of Life",
    zoologyBlock: "Locomotion and Movement",
    physicsKeywords: ["Gravitation", "Kepler Laws", "Escape Velocity"],
    chemistryKeywords: ["Equilibrium", "Chemical Equilibrium", "Ionic Equilibrium", "pH", "Buffer Solutions"],
    botanyKeywords: ["Cell: The Unit of Life", "Prokaryotic Cell", "Eukaryotic Cell", "Cell Organelles"],
    zoologyKeywords: ["Locomotion and Movement", "Muscles and Muscle Contraction", "Skeletal System", "Joints"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Mechanical Properties of Solids; Mechanical Properties of Fluids (Phy) + Redox Reactions (Chem) + Biomolecules (Bot) + Neural Control and Coordination (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-07 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Mechanical Properties of Solids; Mechanical Properties of Fluids",
    chemistryUnit: "Redox Reactions",
    botanyBlock: "Biomolecules",
    zoologyBlock: "Neural Control and Coordination",
    physicsKeywords: ["Mechanical Properties of Solids", "Mechanical Properties of Fluids", "Elasticity", "Surface Tension", "Viscosity"],
    chemistryKeywords: ["Redox Reactions", "Oxidation Number", "Balancing Redox"],
    botanyKeywords: ["Biomolecules", "Carbohydrates", "Proteins", "Lipids", "Nucleic Acids", "Enzymes"],
    zoologyKeywords: ["Neural Control and Coordination", "Human Nervous System", "Neuron and Nerve Impulse", "Reflex Action", "Sensory Organs"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Thermal Properties of Matter (Phy) + Organic Chemistry \u2013 Some Basic Principles and Techniques (Chem) + Cell Cycle and Cell Division (Bot) + Chemical Coordination and Integration (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-08 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Thermal Properties of Matter",
    chemistryUnit: "Organic Chemistry \u2013 Some Basic Principles and Techniques",
    botanyBlock: "Cell Cycle and Cell Division",
    zoologyBlock: "Chemical Coordination and Integration",
    physicsKeywords: ["Thermal Properties of Matter", "Calorimetry", "Thermal Expansion"],
    chemistryKeywords: ["Organic Chemistry - Some Basic Principles and Techniques", "GOC", "IUPAC Nomenclature", "Isomerism", "Reaction Mechanisms"],
    botanyKeywords: ["Cell Cycle and Cell Division", "Mitosis", "Meiosis"],
    zoologyKeywords: ["Chemical Coordination and Integration", "Endocrine Glands", "Hormones and Feedback"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Thermodynamics; Kinetic Theory (Phy) + Hydrocarbons (Chem) + Photosynthesis in Plants (Bot) + Body Fluids and Circulation (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-09 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Thermodynamics; Kinetic Theory",
    chemistryUnit: "Hydrocarbons",
    botanyBlock: "Photosynthesis in Plants",
    zoologyBlock: "Body Fluids and Circulation",
    physicsKeywords: ["Thermodynamics", "First Law of Thermodynamics", "Second Law of Thermodynamics", "Carnot Engine", "Kinetic Theory of Gases", "KTG", "Gas Laws"],
    chemistryKeywords: ["Hydrocarbons", "Alkanes", "Alkenes", "Alkynes", "Aromatic Hydrocarbons"],
    botanyKeywords: ["Photosynthesis in Higher Plants", "Light Reaction", "Calvin Cycle", "C4 Pathway"],
    zoologyKeywords: ["Body Fluids and Circulation", "Blood and Lymph", "Human Heart", "Cardiac Cycle", "ECG"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Oscillations (Phy) + Chemical Bonding and Molecular Structure (Chem) + Respiration in Plants (Bot) + Excretory Products and Their Elimination (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-10 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Oscillations",
    chemistryUnit: "Chemical Bonding and Molecular Structure",
    botanyBlock: "Respiration in Plants",
    zoologyBlock: "Excretory Products and Their Elimination",
    physicsKeywords: ["Oscillations", "Simple Harmonic Motion", "SHM"],
    chemistryKeywords: ["Chemical Bonding and Molecular Structure", "Hybridization", "VSEPR Theory", "Molecular Orbital Theory"],
    botanyKeywords: ["Respiration in Plants", "Glycolysis", "Krebs Cycle", "ETS and Oxidative Phosphorylation"],
    zoologyKeywords: ["Excretory Products and Their Elimination", "Human Excretory System", "Urine Formation", "Regulation of Kidney Function"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Waves (Phy) + Equilibrium (Chem) + Plant Growth and Development (Bot) + Chemical Coordination and Integration (Zoo)",
    objective: "Class 11 NEET preparation Phase 1: Chapter-Wise: CW-11 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Waves",
    chemistryUnit: "Equilibrium",
    botanyBlock: "Plant Growth and Development",
    zoologyBlock: "Chemical Coordination and Integration",
    physicsKeywords: ["Waves", "Sound Waves", "Doppler Effect", "String Waves"],
    chemistryKeywords: ["Equilibrium", "Chemical Equilibrium", "Ionic Equilibrium", "pH", "Buffer Solutions"],
    botanyKeywords: ["Plant Growth and Development", "Plant Hormones", "Auxins", "Gibberellins", "Photoperiodism"],
    zoologyKeywords: ["Chemical Coordination and Integration", "Endocrine Glands", "Hormones and Feedback"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Units and Measurements; Motion in a Straight Line; Motion in a Plane (Phy) + Some Basic Concepts of Chemistry; Structure of Atom (Chem) + The Living World; Biological Classification (Bot) + Animal Kingdom (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-01 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Units and Measurements; Motion in a Straight Line; Motion in a Plane",
    chemistryUnit: "Some Basic Concepts of Chemistry; Structure of Atom",
    botanyBlock: "The Living World; Biological Classification",
    zoologyBlock: "Animal Kingdom",
    physicsKeywords: ["Units and Measurement", "Physical World", "Vectors", "Motion in a Straight Line", "Motion in a Plane", "Kinematics"],
    chemistryKeywords: ["Some Basic Concepts of Chemistry", "Mole Concept", "Stoichiometry", "Structure of Atom", "Quantum Numbers", "Photoelectric Effect"],
    botanyKeywords: ["The Living World", "Taxonomy", "Binomial Nomenclature", "Biological Classification", "Monera", "Protista", "Fungi", "Viruses"],
    zoologyKeywords: ["Animal Kingdom", "Invertebrates", "Chordates", "Non-chordates"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Laws of Motion; Work, Energy and Power (Phy) + Classification of Elements and Periodicity in Properties; Chemical Bonding and Molecular Structure (Chem) + Plant Kingdom; Morphology of Flowering Plants (Bot) + Structural Organisation in Animals (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-02 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Laws of Motion; Work, Energy and Power",
    chemistryUnit: "Classification of Elements and Periodicity in Properties; Chemical Bonding and Molecular Structure",
    botanyBlock: "Plant Kingdom; Morphology of Flowering Plants",
    zoologyBlock: "Structural Organisation in Animals",
    physicsKeywords: ["Laws of Motion", "Friction", "Circular Motion", "Work, Energy and Power", "Power", "Energy"],
    chemistryKeywords: ["Classification of Elements and Periodicity in Properties", "Periodic Table", "Periodic Properties", "Chemical Bonding and Molecular Structure", "Hybridization", "VSEPR Theory", "Molecular Orbital Theory"],
    botanyKeywords: ["Plant Kingdom", "Algae", "Bryophytes", "Pteridophytes", "Gymnosperms", "Angiosperms", "Morphology of Flowering Plants", "Root, Stem, Leaf", "Inflorescence", "Flower, Fruit, Seed"],
    zoologyKeywords: ["Structural Organisation in Animals", "Animal Tissues", "Epithelial Tissue", "Connective Tissue", "Frog"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "System of Particles and Rotational Motion; Gravitation (Phy) + Thermodynamics (Chem) + Anatomy of Flowering Plants; Cell: The Unit of Life (Bot) + Breathing and Exchange of Gases; Body Fluids and Circulation (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-03 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "System of Particles and Rotational Motion; Gravitation",
    chemistryUnit: "Thermodynamics",
    botanyBlock: "Anatomy of Flowering Plants; Cell: The Unit of Life",
    zoologyBlock: "Breathing and Exchange of Gases; Body Fluids and Circulation",
    physicsKeywords: ["System of Particles and Rotational Motion", "Rotational Motion", "Moment of Inertia", "Gravitation", "Kepler Laws", "Escape Velocity"],
    chemistryKeywords: ["Thermodynamics", "Chemical Thermodynamics", "Enthalpy", "Entropy"],
    botanyKeywords: ["Anatomy of Flowering Plants", "Meristematic Tissues", "Permanent Tissues", "Secondary Growth", "Cell: The Unit of Life", "Prokaryotic Cell", "Eukaryotic Cell", "Cell Organelles"],
    zoologyKeywords: ["Breathing and Exchange of Gases", "Respiratory Volumes", "Gas Transport", "Body Fluids and Circulation", "Blood and Lymph", "Human Heart", "Cardiac Cycle", "ECG"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Mechanical Properties of Solids; Mechanical Properties of Fluids (Phy) + Equilibrium (Chem) + Biomolecules; Cell Cycle and Cell Division (Bot) + Excretory Products and Their Elimination; Locomotion and Movement (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-04 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Mechanical Properties of Solids; Mechanical Properties of Fluids",
    chemistryUnit: "Equilibrium",
    botanyBlock: "Biomolecules; Cell Cycle and Cell Division",
    zoologyBlock: "Excretory Products and Their Elimination; Locomotion and Movement",
    physicsKeywords: ["Mechanical Properties of Solids", "Mechanical Properties of Fluids", "Elasticity", "Surface Tension", "Viscosity"],
    chemistryKeywords: ["Equilibrium", "Chemical Equilibrium", "Ionic Equilibrium", "pH", "Buffer Solutions"],
    botanyKeywords: ["Biomolecules", "Carbohydrates", "Proteins", "Lipids", "Nucleic Acids", "Enzymes", "Cell Cycle and Cell Division", "Mitosis", "Meiosis"],
    zoologyKeywords: ["Excretory Products and Their Elimination", "Human Excretory System", "Urine Formation", "Regulation of Kidney Function", "Locomotion and Movement", "Muscles and Muscle Contraction", "Skeletal System", "Joints"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Thermal Properties of Matter; Thermodynamics; Kinetic Theory (Phy) + Redox Reactions; Organic Chemistry \u2013 Some Basic Principles and Techniques (Chem) + Photosynthesis in Plants; Respiration in Plants (Bot) + Neural Control and Coordination (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-05 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Thermal Properties of Matter; Thermodynamics; Kinetic Theory",
    chemistryUnit: "Redox Reactions; Organic Chemistry \u2013 Some Basic Principles and Techniques",
    botanyBlock: "Photosynthesis in Plants; Respiration in Plants",
    zoologyBlock: "Neural Control and Coordination",
    physicsKeywords: ["Thermal Properties of Matter", "Calorimetry", "Thermal Expansion", "Thermodynamics", "First Law of Thermodynamics", "Second Law of Thermodynamics", "Carnot Engine", "Kinetic Theory of Gases", "KTG", "Gas Laws"],
    chemistryKeywords: ["Redox Reactions", "Oxidation Number", "Balancing Redox", "Organic Chemistry - Some Basic Principles and Techniques", "GOC", "IUPAC Nomenclature", "Isomerism", "Reaction Mechanisms"],
    botanyKeywords: ["Photosynthesis in Higher Plants", "Light Reaction", "Calvin Cycle", "C4 Pathway", "Respiration in Plants", "Glycolysis", "Krebs Cycle", "ETS and Oxidative Phosphorylation"],
    zoologyKeywords: ["Neural Control and Coordination", "Human Nervous System", "Neuron and Nerve Impulse", "Reflex Action", "Sensory Organs"],
    totalQuestions: 180,
    durationMinutes: 180,
    totalMarks: 720
  },
  {
    ...
    description: "Oscillations; Waves (Phy) + Hydrocarbons (Chem) + Plant Growth and Development (Bot) + Chemical Coordination and Integration (Zoo)",
    objective: "Class 11 NEET preparation Phase 2: Part-Wise: PT-06 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Oscillations; Waves",
    chemistryUnit: "Hydrocarbons",
    botanyBlock: "Plant Growth and Development",
    zoologyBlock: "Chemical Coordination and Integration",
    physicsKeywords: ["Oscillations", "Simple Harmonic Motion", "SHM", "Waves", "Sound Waves", "Doppler Effect", "String Waves"],
    chemistryKeywords: ["Hydrocarbons", "Alkanes", "Alkenes", "Alkynes", "Aromatic Hydrocarbons"],
    botanyKeywords: ["Plant Growth and Development", "Plant Hormones", "Auxins", "Gibberellins", "Photoperiodism"],
    zoologyKeywords: ["Chemical Coordination and Integration", "Endocrine Glands", "Hormones and Feedback"],
    totalQuestions: 180,
  ...
  },
  {
    ...
    description: "Full Class 11 NEET Syllabus Test across Physics, Chemistry, Botany, and Zoology. Strictly Class 11 scope only.",
    objective: "Class 11 NEET preparation Phase 3: Full Syllabus: FS-01 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Entire Class 11 Physics",
    chemistryUnit: "Entire Class 11 Chemistry",
    botanyBlock: "Entire Class 11 Botany",
    zoologyBlock: "Entire Class 11 Zoology",
    physicsKeywords: ["All Chapters"],
    chemistryKeywords: ["All Chapters"],
    botanyKeywords: ["All Chapters"],
    zoologyKeywords: ["All Chapters"],
  ...
  },
  {
    ...
    description: "Full Class 11 NEET Syllabus Test across Physics, Chemistry, Botany, and Zoology. Strictly Class 11 scope only.",
    objective: "Class 11 NEET preparation Phase 3: Full Syllabus: FS-02 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Entire Class 11 Physics",
    chemistryUnit: "Entire Class 11 Chemistry",
    botanyBlock: "Entire Class 11 Botany",
    zoologyBlock: "Entire Class 11 Zoology",
  ...
  },
  {
    ...
    description: "Full Class 11 NEET Syllabus Test across Physics, Chemistry, Botany, and Zoology. Strictly Class 11 scope only.",
    objective: "Class 11 NEET preparation Phase 3: Full Syllabus: FS-03 assessing prescribed NCERT topics with zero intra-paper duplicate questions.",
    physicsUnit: "Entire Class 11 Physics",
    chemistryUnit: "Entire Class 11 Chemistry",
    botanyBlock: "Entire Class 11 Botany",
    zoologyBlock: "Entire Class 11 Zoology",
...
export const SUNDAY_11TH_TRACK2_TESTS: SundayPlannerTest[] = [
...
/**
 * DEFAULT CLASS 11TH PLANNER TESTS (Points to Track 1 by default)
 */
export const SUNDAY_11TH_PLANNER_TESTS: SundayPlannerTest[] = SUNDAY_11TH_TRACK1_TESTS;
...
export function ensureAllSundayPapersGenerated(): void {
  ...
  const totalExpectedTests = allDropperTests.length + PLANNER_12TH_COMPLETE_TESTS.length + PLANNER_12TH_PC_TESTS.length + SUNDAY_11TH_TRACK1_TESTS.length + SUNDAY_11TH_TRACK2_TESTS.length;
  ...
  const trackConfigs: Array<{
    ...
    { batch: '11th', trackPrefix: 'track1_', tests: SUNDAY_11TH_TRACK1_TESTS },
