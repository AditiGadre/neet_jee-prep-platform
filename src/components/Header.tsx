      ...
      <div className="w-full px-4 sm:px-6">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white font-black text-sm shadow-xs tracking-tight">
              nc
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-extrabold text-base tracking-tight text-gray-900">
                  NEET<span className="text-blue-600">cbt</span>
                </span>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="hidden md:flex items-center gap-2 bg-gray-50 px-2.5 py-1 rounded text-xs text-gray-600 border border-gray-200 font-mono text-[11px]">
              ...
              <span className="text-[10px] uppercase font-bold text-gray-700">CBT Engine Online</span>
            </div>
